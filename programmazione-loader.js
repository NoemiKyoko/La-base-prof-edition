(() => {
  ...
  const STORAGE_KEY = "LaBaseProfEditionProgrammazioneV1";
  const VIEW_KEY = "LaBaseProfEditionProgrammazioneVistaV1";
  const STICKERS_KEY = "LaBaseProfEditionProgrammazioneStickerV1";
